...
\033[1;91m ╚═╝░░╚══╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═════╝░
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ SOUROV KHAN NAHID       ║    
\033[1;98m║
...
CorrectUsername = "SOUROV KHAN NAHID"
CorrectPassword = "Nahid09638999792@"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/SOUROV.KHAN.NAHID')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mSOUROV KHAN NAHID\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mSOUROV KHAN NAHID\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mSOUROV KHAN NAHID start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════💥══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mSOUROV KHAN NAHID-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mSOUROV KHAN NAHID-Checkpoint'
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mSOUROV KHAN NAHID\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By SOUROV KHAN NAHID--•◈•---»" #Dev:SOUROV KHAN NAHID
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 SOUROV KHAN NAHID.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..SOUROV KHAN NAHID Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mSOUROV.KHAN.NAHID """
